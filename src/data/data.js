...
export const servicesData = [
  {
    ...
    title: "photographer",
    desc: `I have great skills when it comes to photography and photo-editing.`,
  },
  {
    icon: <img src={design} />,
    title: "design",
    desc: `I design websites with the latest UX/UI designs with figma & adobe photoshop.`,
  },
  {
    icon: (
    ...
    title: "frontend",
    desc: `I am a proficient frontend developer with skills in React js, HTML, SASS, Vanilla JavaScript technologies.`,
  },
  {
    icon: (
    ...
    title: "backend",
    desc: `I am a proficient backend developer with skills in both Django and Django Restframework technologies.`,
  },
  // {
  //   icon: <img src={code} />,
  //   title: "promote",
